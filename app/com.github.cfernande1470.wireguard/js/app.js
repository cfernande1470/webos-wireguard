...
const I18N = {
  en: {
    ...
    rootedTv: "Rooted TV",
    controlsKicker: "CONTROL CENTER",
    controlsTitle: "Tunnel controls",
    installHint: "Prepare components",
    startHint: "Bring tunnel online",
    stopHint: "Take tunnel offline",
    activityKicker: "LIVE OUTPUT",
    activityTitle: "Activity",
    consoleReady: "Console ready",
    currentStatus: "CURRENT STATUS",
    terminalTitle: "WireGuard console",
    bootHint: "Launch the tunnel automatically",
  ...
  es: {
    ...
    rootedTv: "TV rooteada",
    controlsKicker: "CENTRO DE CONTROL",
    controlsTitle: "Controles del túnel",
    installHint: "Preparar componentes",
    startHint: "Activar el túnel",
    stopHint: "Desactivar el túnel",
    activityKicker: "SALIDA EN DIRECTO",
    activityTitle: "Actividad",
    consoleReady: "Consola lista",
    currentStatus: "ESTADO ACTUAL",
    terminalTitle: "Consola WireGuard",
    bootHint: "Iniciar el túnel automáticamente",
